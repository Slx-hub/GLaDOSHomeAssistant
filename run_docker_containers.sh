...
docker run -d --restart=unless-stopped --network smart-home -p 12101:12101 --name gladosrhasspy -v $(pwd)/setup_files/rhasspy-profiles:/profiles gladosrhasspy:latest
